...
public class Pickups : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if(other.gameObject.tag == "Fighter")
        {
            ...
            // if(gameObject.name == "key1")//check if this gameObject is key1
            // {
            //     imageKey1.enabled = true;
            // }
            // if(gameObject.name == "key2")//check if this gameObject is key2
            // {
            //     imageKey2.enabled = true;
            // }
            // if(gameObject.name == "key3")//check if this gameObject is key3
            // {
            //     imageKey3.enabled = true;
            // }
            // if(gameObject.name == "gPotion")//check if this gameObject is gPotion
            // {
            //     imageGPotion.enabled = true;
            // }
            // if(gameObject.name == "rPotion")//check if this gameObject is rPotion
            // {
            //     imageRPotion.enabled = true;
            // }
